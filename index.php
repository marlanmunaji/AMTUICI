...
// Fetch all tasks ordered by deadline
$stmt = $pdo->query("SELECT * FROM tasks ORDER BY tgl_deadline ASC, waktu_deadline ASC");
$tasks = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    ...
    <script>
        ...
        function viewTask(id) {
            fetch(BASE_URL + '?action=detail&id=' + id)
            .then(res => res.json())
            .then(response => {
        ...
        document.getElementById('editTaskForm').addEventListener('submit', function(e) {
            ...
            fetch(BASE_URL + '?action=update&id=' + id, {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
        ...
        document.getElementById('statusTaskForm').addEventListener('submit', function(e) {
            ...
            fetch(BASE_URL + '?action=update_status&id=' + id, {
                method: 'POST',
                body: formData
            })
            .then(res => res.json())
